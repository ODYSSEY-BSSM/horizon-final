...
import { MOCK_SCHOOL_INFO, MOCK_SCHOOL_NODES } from '../_constants/schoolConnect.constants';
import type { ModalState, SchoolConnectState } from '../_types/schoolConnect.types';
