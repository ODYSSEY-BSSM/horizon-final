...
export default function AddFolderCard({ onClick }: AddFolderCardProps) {
  return (
    <StyledCard onClick={onClick}>
      <StyledContent>
        ...
        <StyledTextSection>
          <StyledTitle>새 폴더 생성</StyledTitle>
          <StyledDescription>새 로드맵들을 위한 폴더를 생성하세요</StyledDescription>
        </StyledTextSection>
      </StyledContent>
    </StyledCard>
  );
